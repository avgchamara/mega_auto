...
\033[1;33;40m     |  \/  | ___  __ _   / \    |  _ \ _   _| \ | |
\033[1;31;40m     | |\/| |/ _ \/ _` | / O \   | |_) | | | |  \| |
\033[1;33;40m     | |  | |  __/ (_| |/ ___ \  |  _ <| |_| | |\  |
\033[1;31;40m     |_|  |_|\___|\__, /_/   \_\ |_| \_\\___/|_| \_|
\033[1;33;40m                  |___/

\033[1;37;40m              [+][+] BL_Seeker [+][+]
...
def main():
	...
	while True:
		...
		if resp == '<Response [204]>':
			...
			print(bar)
			print("\n\033[1;32;40m [>>>] You Won Data Bundle..")
			print(bar)
		else:
			print(bar)
			print("\n\033[1;31;40m [>>>] Check you are Blocked User and Try Again..")
			print(bar)
